<?php
//======================================================================
// Code added by DreamWeaver
// Recordset rs_freelancer created to get all Portfolio table information
//======================================================================

require_once('Connections/Freelancer.php'); // Connect to mysql ?>
...
/* This function prints the compiled HTML */
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <h1 class="name"><?php echo $pagetitle ?></h1>
                        <hr class="star-light">
    ...
    <section class="success" id="about">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <p>This version uses PHP and MySQL to manage the rudimentary Portfolio, which greatly reduces (the now 'index.php') file size. You can use myPHPAdmin to add or delete items, rather than cutting and pasting new thumbnail and modal blocks of HTML.</p>
                </div>
